...
#python clustering.py -s ./ims_2019_01_16_cluster.py --tissue_id Tonsil_D2 --hierarchical_clustering --nb_clusters 60  --distance euclidean --method ward
python clustering.py -s ./ims_2019_01_16_cluster.py --tissue_id Tonsil_D2 --hierarchical_clustering --nb_clusters 60  --distance euclidean --method ward --load_clustering --cluster_maps --cluster_galleries
